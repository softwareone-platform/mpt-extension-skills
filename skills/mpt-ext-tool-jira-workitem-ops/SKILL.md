...
- When an MCP Jira integration is available in the environment, you may use it instead of `acli` for the same operations. Prefer whichever is available and convenient.
