...
- [jira-fields.md](./standards/jira-fields.md): single source of truth for MPT Jira custom-field IDs (Team, Sprint, Keywords, HitCount, Environment) used by Jira skills
